...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/titiler-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14320&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/titiler-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `titiler-core` can be installed with:

```
conda install titiler-core
```

It is possible to list all of the versions of `titiler-core` available on your platform with:
